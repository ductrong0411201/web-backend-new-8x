...
class RoleRepository extends BaseRepository
{
    ...
    {
        return $this->query()->where('id', 2)->first();

    }

    public function districtRole()
    {
        return $this->query()->where('id', 4)->first();
    }
    public function adminRole()
    {
        return $this->query()->where('id', 5)->first();
    }

    public function superDepartment()
    {
        return $this->query()->where('id', 6)->first();
    }
}
